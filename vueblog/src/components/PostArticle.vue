<template>
  <el-container v-loading="loading" class="post-article">
    <el-header class="header">
      <el-select v-model="article.cid" placeholder="请选择项目" style="width: 150px;">
        <el-option
    ...
    <el-main class="main">
      ...
      <div style="display: flex;align-items: center;margin-top: 15px;justify-content: flex-end">
        ...
        <template v-if="from==undefined || from=='draft'">
          ...
          <el-button type="primary" @click="open4">模板生成</el-button>
          <el-button type="primary" @click="saveBlog(1)">新建合同</el-button>
        </template>
